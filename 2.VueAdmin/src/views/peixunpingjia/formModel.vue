		...
		<el-dialog v-model="formVisible" :title="formTitle" width="80%" destroy-on-close :fullscreen='false'>
			<el-form class="formModel_form" ref="formRef" :model="form" label-width="$template2.back.add.form.base.labelWidth" :rules="rules">
				<el-row>
					...
					<el-col :span="12">
						<el-form-item label="培训评价" prop="peixunpingjia">
							<el-input v-model="form.peixunpingjia" placeholder="培训评价" type="textarea"
							:readonly="!isAdd||disabledForm.peixunpingjia?true:false"
							/>
						</el-form-item>
					</el-col>
				</el-row>
	...
	const init=(formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null)=>{
		...
		if(formType == 'add'){
			...
			for(let x in row){
				...
				if(x=='peixunpingjia'){
					form.value.peixunpingjia = row[x];
					disabledForm.value.peixunpingjia = true;
					continue;
				}
