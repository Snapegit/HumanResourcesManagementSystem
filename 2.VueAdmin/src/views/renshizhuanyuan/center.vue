				...
				<el-row>
					<el-col :span="12">
						<el-form-item label="专员账号" prop="zhuanyuanzhanghao">
							<el-input class="list_inp" v-model="user.zhuanyuanzhanghao" readonly placeholder="专员账号" clearable />
						</el-form-item>
					</el-col>
					<el-col :span="12">
						<el-form-item label="专员名称" prop="zhuanyuanmingcheng">
							<el-input class="list_inp" v-model="user.zhuanyuanmingcheng"  placeholder="专员名称" clearable />
						</el-form-item>
					</el-col>
					<el-col :span="12">
						<el-form-item label="封面" prop="fengmian">
							<uploads
								...
								@change="renshizhuanyuanfengmianUploadSuccess">
							</uploads>
						</el-form-item>
					</el-col>
					<el-col :span="12">
...
<script setup>
	...
	const tableName = ref('renshizhuanyuan')
	const user = ref({})
	const init = () => {
	}
	const renshizhuanyuanfengmianUploadSuccess=(fileUrls)=> {
	    user.value.fengmian = fileUrls;
	}
	const onSubmit = () => {
		if((!user.value.zhuanyuanzhanghao)){
			context?.$toolUtil.message(`专员账号不能为空`,'error')
			return false
		}
		if((!user.value.mima)){
		...
		if((!user.value.zhuanyuanmingcheng)){
			context?.$toolUtil.message(`专员名称不能为空`,'error')
			return false
		}
