	...
	<div>
		<div class="app-contain">
			<div class="list_search_view">
				<el-form :model="searchQuery" class="search_form" >
					<div class="search_view">
						...
						<div class="search_box">
							<el-input class="search_inp" v-model="searchQuery.zhuanyuanmingcheng" placeholder="专员名称"
								clearable>
							</el-input>
						</div>
					</div>
				...
				<br>
				<div class="btn_view">
					<el-button type="success" @click="addClick" v-if="btnAuth('renshizhuanyuan','新增')">新增</el-button>
					<el-button type="primary" :disabled="selRows.length==1?false:true" @click="editClick" v-if=" btnAuth('renshizhuanyuan','修改')">修改</el-button>
					<el-button type="danger" :disabled="selRows.length?false:true" @click="delClick(null)"  v-if="btnAuth('renshizhuanyuan','删除')">删除</el-button>
				</div>
			</div>
			<br>
			<el-table
				...
				ref="table"
				v-if="btnAuth('renshizhuanyuan','查看')"
				:data="list"
				...
				<el-table-column label="审核" v-if="btnAuth('renshizhuanyuan','审核')" :resizable='true' :sortable='false' align="left" header-align="left">
					<template #default="scope">
...
<script setup>
	...
	//基础信息
	const tableName = 'renshizhuanyuan'
	const formName = '人事专员'
	...
	const getList = () => {
		...
		if(searchQuery.value.zhuanyuanmingcheng&&searchQuery.value.zhuanyuanmingcheng!=''){
			params['zhuanyuanmingcheng'] = '%' + searchQuery.value.zhuanyuanmingcheng + '%'
		}
          if(searchQuery.value.sfsh && searchQuery.value.sfsh!=''){
            params['sfsh'] = searchQuery.value.sfsh
          }
