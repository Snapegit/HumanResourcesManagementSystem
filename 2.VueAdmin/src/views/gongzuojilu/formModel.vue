		...
		<el-dialog v-model="formVisible" :title="formTitle" width="80%" destroy-on-close :fullscreen='false'>
			<el-form class="formModel_form" ref="formRef" :model="form" label-width="$template2.back.add.form.base.labelWidth" :rules="rules">
				<el-row>
					...
					<el-col :span="12">
						<el-form-item label="工作简介" prop="gongzuojianjie">
							<el-input v-model="form.gongzuojianjie" placeholder="工作简介" type="textarea"
							:readonly="!isAdd||disabledForm.gongzuojianjie?true:false"
							/>
						</el-form-item>
					</el-col>
					<el-col :span="12">
						<el-form-item label="工作详情" prop="gongzuoxiangqing">
							<editor :value="form.gongzuoxiangqing" placeholder="请输入工作详情" :readonly="!isAdd||disabledForm.gongzuoxiangqing?true:false"
								class="list_editor" @change="(e)=>editorChange(e,'gongzuoxiangqing')"></editor>
						</el-form-item>
					</el-col>
				</el-row>
			</el-form>
...
<script setup>
	...
	const getInfo = ()=>{
		context?.$http({
			...
			res.data.data.gongzuoxiangqing = res.data.data.gongzuoxiangqing?(res.data.data.gongzuoxiangqing.replace(reg,'../../../cl7341662/file')):'';
	...
	const init=(formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null)=>{
		...
		if(formType == 'add'){
			...
			for(let x in row){
				...
				if(x=='gongzuojianjie'){
					form.value.gongzuojianjie = row[x];
					disabledForm.value.gongzuojianjie = true;
					continue;
				}
				if(x=='gongzuoxiangqing'){
					form.value.gongzuoxiangqing = row[x];
					disabledForm.value.gongzuoxiangqing = true;
					continue;
				}
