...
public class JixiaokaoheController {
    ...
    public R page(@RequestParam Map<String, Object> params,JixiaokaoheEntity jixiaokaohe,
		...
		if(tableName.equals("renshizhuanyuan")) {
			jixiaokaohe.setZhuanyuanzhanghao((String)request.getSession().getAttribute("username"));
		}
    ...
    public R info(@PathVariable("id") Long id){
		...
		jixiaokaohe = jixiaokaoheService.selectView(new EntityWrapper<JixiaokaoheEntity>().eq("id", id));
