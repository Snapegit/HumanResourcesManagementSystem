	...
	<div class="app-contain" :style='{"padding":"0 12%","margin":"10px auto 20px","alignItems":"flex-start","borderRadius":"0px","flexWrap":"wrap","background":"none","display":"flex","width":"100%","position":"relative","justifyContent":"space-between"}'>
		...
		<div class="detail_view">
			...
			<div class="info_view">
				...
				<div class="info_item">
					<div class="info_label">培训时间</div>
					<div  class="info_text" >{{detail.peixunshijian}}</div>
				</div>
				<div class="info_item">
					<div class="info_label">培训地址</div>
					<div  class="info_text" >{{detail.peixundizhi}}</div>
				</div>
				<div class="info_item">
					<div class="info_label">培训计划</div>
					<div  class="info_text" >{{detail.peixunjihua}}</div>
				</div>
				<div class="info_item">
					<div class="info_label">培训材料</div>
					<div  class="info_text" >{{detail.peixuncailiao}}</div>
				</div>
				<div class="info_item">
					<div class="info_label">培训内容</div>
					<div  class="info_text" >{{detail.peixunneirong}}</div>
				</div>
				<div class="info_item">
				...
				<div class="btn_view">
					<el-button class="cross_btn" v-if="btnFrontAuth(tableName,'评价')" @click="peixunpingjiaonAcross('评价','peixunpingjia','','','')" type="warning">评价</el-button>
					<el-button class="edit_btn" v-if="centerType&&btnAuth('canjiapeixun','修改')" type="primary" @click="editClick">修改</el-button>
					<el-button class="del_btn" v-if="centerType&&btnAuth('canjiapeixun','删除')" type="danger" @click="delClick">删除</el-button>
				</div>
			</div>
		</div>
...
<script setup>
	...
	const getDetail = () => {
		context?.$http({
			...
			title.value = res.data.data.peixunzhuti
	...
	const peixunpingjiaonAcross = (btnType,table,crossOptAudit,statusColumnName,tips,statusColumnValue) => {
