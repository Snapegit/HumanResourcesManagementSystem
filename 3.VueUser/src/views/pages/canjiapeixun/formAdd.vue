				...
				<el-col :span="8">
					<el-form-item label="培训主题" prop="peixunzhuti">
						<el-input class="list_inp" v-model="form.peixunzhuti" placeholder="培训主题"
							 type="text" 							:readonly="!isAdd||disabledForm.peixunzhuti?true:false" />
					</el-form-item>
				</el-col>
				...
				<el-col :span="8">
					<el-form-item label="培训时间" prop="peixunshijian">
						<el-input class="list_inp" v-model="form.peixunshijian" placeholder="培训时间"
							 type="text" 							:readonly="!isAdd||disabledForm.peixunshijian?true:false" />
					</el-form-item>
				</el-col>

				<el-col :span="8">
					<el-form-item label="培训地址" prop="peixundizhi">
						<el-input class="list_inp" v-model="form.peixundizhi" placeholder="培训地址"
							 type="text" 							:readonly="!isAdd||disabledForm.peixundizhi?true:false" />
					</el-form-item>
				</el-col>

				<el-col :span="8">
					<el-form-item label="培训计划" prop="peixunjihua">
						<el-input class="list_inp" v-model="form.peixunjihua" placeholder="培训计划"
							 type="text" 							:readonly="!isAdd||disabledForm.peixunjihua?true:false" />
					</el-form-item>
				</el-col>

				<el-col :span="8">
					<el-form-item label="培训材料" prop="peixuncailiao">
						<el-input class="list_inp" v-model="form.peixuncailiao" placeholder="培训材料"
							 type="text" 							:readonly="!isAdd||disabledForm.peixuncailiao?true:false" />
					</el-form-item>
				</el-col>
	...
	const init = (formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null) => {
		...
		if(formType == 'add'){
			...
			for(let x in row){
				...
				if(x=='peixundizhi'){
					form.value.peixundizhi = row[x];
					disabledForm.value.peixundizhi = true;
					continue;
				}
				if(x=='peixunjihua'){
					form.value.peixunjihua = row[x];
					disabledForm.value.peixunjihua = true;
					continue;
				}
				if(x=='peixuncailiao'){
