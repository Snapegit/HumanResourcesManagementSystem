	...
	<div class="app-contain" :style='{"padding":"0 12%","margin":"10px auto 20px","alignItems":"flex-start","borderRadius":"0px","flexWrap":"wrap","background":"none","display":"flex","width":"100%","position":"relative","justifyContent":"space-between"}'>
		...
		<div class="detail_view">
			...
			<div class="info_view">
				...
				<div class="info_item">
					<div class="info_label">员工考勤</div>
					<div  class="info_text" >{{detail.yuangongkaoqin}}</div>
				</div>
				<div class="info_item">
					<div class="info_label">工作态度</div>
					<div  class="info_text" >{{detail.gongzuotaidu}}</div>
				</div>
				<div class="info_item">
					<div class="info_label">业务能力</div>
					<div  class="info_text" >{{detail.yewunengli}}</div>
				</div>
				<div class="info_item">
					<div class="info_label">工作绩效</div>
					<div  class="info_text" >{{detail.gongzuojixiao}}</div>
				</div>
				<div class="info_item">
					<div class="info_label">评价等级</div>
					<div  class="info_text" >{{detail.pingjiadengji}}</div>
				</div>
				<div class="info_item">
				...
				<div class="info_item">
					<div class="info_label">考核时间</div>
					<div  class="info_text" >{{detail.kaoheshijian}}</div>
				</div>
				<div class="info_item">
				...
				<div class="btn_view">
					<el-button class="edit_btn" v-if="centerType&&btnAuth('jixiaokaohe','修改')" type="primary" @click="editClick">修改</el-button>
					<el-button class="del_btn" v-if="centerType&&btnAuth('jixiaokaohe','删除')" type="danger" @click="delClick">删除</el-button>
				</div>
			</div>
		</div>
