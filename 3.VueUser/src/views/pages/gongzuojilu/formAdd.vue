			...
			<el-row>
				...
				<el-col :span="24">
					<el-form-item label="工作详情" prop="gongzuoxiangqing">
						<editor class="list_editor" :value="form.gongzuoxiangqing" placeholder="请输入工作详情" :readonly="!isAdd||disabledForm.gongzuoxiangqing?true:false"
							@change="(e)=>editorChange(e,'gongzuoxiangqing')"></editor>
					</el-form-item>
				</el-col>
			</el-row>
...
<script setup>
	...
	const getInfo = ()=>{
		context?.$http({
			...
			res.data.data.gongzuoxiangqing = res.data.data.gongzuoxiangqing.replace(reg,'../../../cl7341662/file');
