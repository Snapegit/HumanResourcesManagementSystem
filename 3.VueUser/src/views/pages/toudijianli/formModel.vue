	...
	<div class="app-contain" :style='{"padding":"0 12%","margin":"10px auto 20px","alignItems":"flex-start","borderRadius":"0px","flexWrap":"wrap","background":"none","display":"flex","width":"100%","position":"relative","justifyContent":"space-between"}'>
		...
		<div class="detail_view">
			...
			<div class="info_view">
				...
				<div class="info_item">
					<div class="info_label">岗位类型</div>
					<div  class="info_text" >{{detail.gangweileixing}}</div>
				</div>
				<div class="info_item">
				...
				<div class="info_item">
					<div class="info_label">专员账号</div>
					<div  class="info_text" >{{detail.zhuanyuanzhanghao}}</div>
				</div>
				<div class="info_item">
					<div class="info_label">专员名称</div>
					<div  class="info_text" >{{detail.zhuanyuanmingcheng}}</div>
				</div>
				<div class="info_item">
				...
				<div class="info_item">
					<div class="info_label">投递时间</div>
					<div  class="info_text" >{{detail.toudishijian}}</div>
				</div>
				<div class="info_item">
					<div class="info_label">面试状态</div>
					<div  class="info_text" >{{detail.mianshizhuangtai}}</div>
				</div>
				<div class="info_item">
					<div class="info_label">个人简历</div>
					<div class="info_text">
						<el-button class="info_down" v-if="detail.gerenjianli" @click="downClick(detail.gerenjianli)">点击下载</el-button>
						<el-button class="info_undown" v-else>暂无</el-button>
					</div>
				</div>
				<div class="btn_view">
					<el-button class="cross_btn" v-if="btnFrontAuth(tableName,'通知')" @click="mianshitongzhionAcross('通知','mianshitongzhi','','','')" type="warning">通知</el-button>
					<el-button class="edit_btn" v-if="centerType&&btnAuth('toudijianli','修改')" type="primary" @click="editClick">修改</el-button>
					<el-button class="del_btn" v-if="centerType&&btnAuth('toudijianli','删除')" type="danger" @click="delClick">删除</el-button>
				</div>
			</div>
		</div>
...
<script setup>
	...
	const mianshitongzhionAcross = (btnType,table,crossOptAudit,statusColumnName,tips,statusColumnValue) => {
