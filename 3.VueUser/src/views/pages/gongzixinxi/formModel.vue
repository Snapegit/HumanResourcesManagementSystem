	...
	<div class="app-contain" :style='{"padding":"0 12%","margin":"10px auto 20px","alignItems":"flex-start","borderRadius":"0px","flexWrap":"wrap","background":"none","display":"flex","width":"100%","position":"relative","justifyContent":"space-between"}'>
		...
		<div class="detail_view">
			...
			<div class="info_view">
				...
				<div class="info_item">
					<div class="info_label">年月份</div>
					<div  class="info_text" >{{detail.nianyuefen}}</div>
				</div>
				<div class="info_item">
				...
				<div class="info_item">
					<div class="info_label">底薪</div>
					<div  class="info_text" >{{detail.dixin}}</div>
				</div>
				<div class="info_item">
					<div class="info_label">绩效</div>
					<div  class="info_text" >{{detail.jixiao}}</div>
				</div>
				<div class="info_item">
					<div class="info_label">奖金</div>
					<div  class="info_text" >{{detail.jiangjin}}</div>
				</div>
				<div class="info_item">
					<div class="info_label">全勤奖</div>
					<div  class="info_text" >{{detail.quanqinjiang}}</div>
				</div>
				<div class="info_item">
					<div class="info_label">五险一金</div>
					<div  class="info_text" >{{detail.wuxianyijin}}</div>
				</div>
				<div class="info_item">
					<div class="info_label">扣款</div>
					<div  class="info_text" >{{detail.koukuan}}</div>
				</div>
				<div class="info_item">
				...
				<div class="info_item">
					<div class="info_label">工资备注</div>
					<div  class="info_text" >{{detail.gongzibeizhu}}</div>
				</div>
				<div class="btn_view">
					<el-button class="edit_btn" v-if="centerType&&btnAuth('gongzixinxi','修改')" type="primary" @click="editClick">修改</el-button>
					<el-button class="del_btn" v-if="centerType&&btnAuth('gongzixinxi','删除')" type="danger" @click="delClick">删除</el-button>
				</div>
			</div>
		</div>
