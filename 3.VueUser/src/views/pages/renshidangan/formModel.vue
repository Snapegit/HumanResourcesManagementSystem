	...
	<div class="app-contain" :style='{"padding":"0 12%","margin":"10px auto 20px","alignItems":"flex-start","borderRadius":"0px","flexWrap":"wrap","background":"none","display":"flex","width":"100%","position":"relative","justifyContent":"space-between"}'>
		...
		<div class="detail_view">
			...
			<div class="info_view">
				...
				<div class="info_item">
					<div class="info_label">档案编号</div>
					<div  class="info_text" >{{detail.danganbianhao}}</div>
				</div>
				<div class="info_item">
				...
				<div class="info_item">
					<div class="info_label">履历</div>
					<div  class="info_text" >{{detail.lvli}}</div>
				</div>
				<div class="info_item">
					<div class="info_label">入职日期</div>
					<div  class="info_text" >{{detail.ruzhiriqi}}</div>
				</div>
				<div class="info_item">
				...
				<div class="info_item">
					<div class="info_label">档案文件</div>
					<div class="info_text">
						<el-button class="info_down" v-if="detail.danganwenjian" @click="downClick(detail.danganwenjian)">点击下载</el-button>
						<el-button class="info_undown" v-else>暂无</el-button>
					</div>
				</div>
				<div class="info_item">
					<div class="info_label">合同</div>
					<div class="info_text">
						<el-button class="info_down" v-if="detail.hetong" @click="downClick(detail.hetong)">点击下载</el-button>
						<el-button class="info_undown" v-else>暂无</el-button>
					</div>
				</div>
				<div class="btn_view">
					<el-button class="edit_btn" v-if="centerType&&btnAuth('renshidangan','修改')" type="primary" @click="editClick">修改</el-button>
					<el-button class="del_btn" v-if="centerType&&btnAuth('renshidangan','删除')" type="danger" @click="delClick">删除</el-button>
				</div>
			</div>
		</div>
