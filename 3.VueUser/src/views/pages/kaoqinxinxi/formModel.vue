	...
	<div class="app-contain" :style='{"padding":"0 12%","margin":"10px auto 20px","alignItems":"flex-start","borderRadius":"0px","flexWrap":"wrap","background":"none","display":"flex","width":"100%","position":"relative","justifyContent":"space-between"}'>
		...
		<div class="detail_view">
			...
			<div class="info_view">
				...
				<div class="info_item">
					<div class="info_label">出勤天数</div>
					<div  class="info_text" >{{detail.chuqintianshu}}</div>
				</div>
				<div class="info_item">
				...
				<div class="info_item">
					<div class="info_label">迟到天数</div>
					<div  class="info_text" >{{detail.chidaotianshu}}</div>
				</div>
				<div class="info_item">
				...
				<div class="info_item">
					<div class="info_label">缺勤天数</div>
					<div  class="info_text" >{{detail.queqintianshu}}</div>
				</div>
				<div class="info_item">
