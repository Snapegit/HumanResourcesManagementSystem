...
<template>
	<div class="app-contain" :style='{"minHeight":"100vh","padding":"0","margin":"20px auto 60px","borderRadius":"0px","background":"#fff","width":"76%","position":"relative","height":"100%"}'>
		...
		<el-form ref="formRef" :model="form" class="add_form" label-width="120px" :rules="rules">
			<el-row>
				<el-col :span="8">
					<el-form-item label="标准名称" prop="biaozhunmingcheng">
						<el-input class="list_inp" v-model="form.biaozhunmingcheng" placeholder="标准名称"
							 type="text" 							:readonly="!isAdd||disabledForm.biaozhunmingcheng?true:false" />
					</el-form-item>
				</el-col>
				...
				<el-col :span="24">
					<el-form-item label="员工考勤" prop="yuangongkaoqin">
						<el-input v-model="form.yuangongkaoqin" placeholder="员工考勤" type="textarea"
						:readonly="!isAdd||disabledForm.yuangongkaoqin?true:false"
						/>
					</el-form-item>
				</el-col>
				<el-col :span="24">
					<el-form-item label="工作态度" prop="gongzuotaidu">
						<el-input v-model="form.gongzuotaidu" placeholder="工作态度" type="textarea"
						:readonly="!isAdd||disabledForm.gongzuotaidu?true:false"
						/>
					</el-form-item>
				</el-col>
				<el-col :span="24">
					<el-form-item label="业务能力" prop="yewunengli">
						<el-input v-model="form.yewunengli" placeholder="业务能力" type="textarea"
						:readonly="!isAdd||disabledForm.yewunengli?true:false"
						/>
					</el-form-item>
				</el-col>
				<el-col :span="24">
					<el-form-item label="工作绩效" prop="gongzuojixiao">
						<el-input v-model="form.gongzuojixiao" placeholder="工作绩效" type="textarea"
						:readonly="!isAdd||disabledForm.gongzuojixiao?true:false"
						/>
					</el-form-item>
				</el-col>
			</el-row>
...
<script setup>
	...
	const init = (formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null) => {
		...
		if(formType == 'add'){
			...
			// getInfo()
			for(let x in row){
				if(x=='biaozhunmingcheng'){
					form.value.biaozhunmingcheng = row[x];
					disabledForm.value.biaozhunmingcheng = true;
					continue;
				}
				if(x=='fengmian'){
