...
<template>
	<div class="app-contain" :style='{"minHeight":"100vh","padding":"0","margin":"20px auto 60px","borderRadius":"0px","background":"#fff","width":"76%","position":"relative","height":"100%"}'>
		...
		<el-form ref="formRef" :model="form" class="add_form" label-width="120px" :rules="rules">
			<el-row>
				<el-col :span="8">
					<el-form-item label="加班时间" prop="jiabanshijian">
						<el-input class="list_inp" v-model="form.jiabanshijian" placeholder="加班时间"
							 type="text" 							:readonly="!isAdd||disabledForm.jiabanshijian?true:false" />
					</el-form-item>
				</el-col>
				...
				<el-col :span="8">
					<el-form-item label="专员账号" prop="zhuanyuanzhanghao">
						<el-select
							...
							style="width:100%;"
							>
							<el-option v-for="(item,index) in zhuanyuanzhanghaoLists" :label="item"
								:value="item"
								>
							</el-option>
						</el-select>
				...
				<el-col :span="24">
					<el-form-item label="加班原因" prop="jiabanyuanyin">
						<el-input v-model="form.jiabanyuanyin" placeholder="加班原因" type="textarea"
						:readonly="!isAdd||disabledForm.jiabanyuanyin?true:false"
						/>
					</el-form-item>
				</el-col>
			</el-row>
	...
	const init = (formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null) => {
		...
		if(formType == 'add'){
			...
			for(let x in row){
				...
				if(x=='jiabanshijian'){
					form.value.jiabanshijian = row[x];
					disabledForm.value.jiabanshijian = true;
					continue;
				}
				if(x=='beizhu'){
